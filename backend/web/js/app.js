!function () {
    var d = document.querySelector(".navbar-menu").innerHTML, M = 7, t = "ru", a = localStorage.getItem("language");
    ...
    function n(e) {
        ...
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = base_url + "assets/images/flags/us.svg" : "ru" == e ? document.getElementById("header-lang-img").src = base_url + "assets/images/flags/russia.svg" : "ch" == e ? document.getElementById("header-lang-img").src = base_url + "assets/images/flags/china.svg" : "fr" == e ? document.getElementById("header-lang-img").src = base_url + "assets/images/flags/french.svg" : "ar" == e && (document.getElementById("header-lang-img").src = base_url + "assets/images/flags/ae.svg"), localStorage.setItem("language", e), null == (a = localStorage.getItem("language")) && n(t), (e = new XMLHttpRequest).open("GET", base_url + "assets/lang/" + a + ".json"), e.onreadystatechange = function () {
            var a;
    ...
    function H() {
        Array.from(document.querySelectorAll("#notificationItemsTabContent .tab-pane")).forEach(function (e) {
            0 < e.querySelectorAll(".notification-item").length ? e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "block") : (e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "none"), e.querySelector(".empty-notification-elem") || (e.innerHTML += '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src="../assets/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">У вас нет новых уведомлений! </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'))
        })
    }
