...
return [
    ...
    'Дата начала маршрута' => [
        ...
        'en' => 'Start date of the route',
        'uz' => 'Marshrutning boshlanish sanasi',
    ],
    'Время начала маршрута' => [
        'ru' => 'Время начала маршрута',
        'en' => 'Route start time',
        'uz' => 'Marshrutning boshlanish vaqti',
    ],
    'Найти транспорт' => [
        'ru' => 'Найти транспорт',
    ...
    'Добро пожаловать в мир комфорта и безопасности с автопарком' => [
        ...
        'uz' => ' Silk Road Samarkand avtoparki bilan qulaylik va xavfsizlik dunyosiga xush kelibsiz!',
    ],
    ...
    'Мы гарантируем точное и надежное выполнение всех услуг, чтобы ваше путешествие началось с хорошего настроения.' => [
        ...
        'uz' => 'Sizning sayohatingiz ijobiy nuqtadan boshlanishini ta\'minlash uchun aniq va ishonchli xizmat ko\'rsatishni kafolatlaymiz.',
    ],
    'Комфорт' => [
        'ru' => 'Комфорт',
        'en' => 'Comfort',
    ...
    'Все наши транспортные средства поддерживаются в идеальном состоянии, а ваша безопасность - нашей первостепенной заботой.' => [
        ...
        'uz' => 'Bizning barcha transport vositalarimiz mukammal holatda saqlanadi va sizning xavfsizligingiz biz uchun eng muhim ustuvorlikdir.',
    ],
    'Профессионализм' => [
        'ru' => 'Профессионализм',
        'en' => 'Professionalism',
    ...
    'Наши водители опытные и заботливые профессионалы, готовые сделать ваше пребывание незабываемым.' => [
        ...
        'uz' => 'Haydovchilarimiz tajribali va e\'tiborli mutaxassislar bo‘lib, sizning tajribangizni unutilmas qilishga tayyorlar.',
    ],
    'properties_desc' => [
        ...
        'uz' => '<strong>Silk Road Samarkand</strong> avtoparki bilan sizning sayohatingiz oson va yoqimli bo\'ladi. Sizning sayohatlaringizni bizga ishonib topshiring, va biz sizga eng qulay va xavfsiz avtotransportda unutilmas tajriba olishingizni kafolatlaymiz.',
    ],
    'Категории доступных транспортов' => [
        'ru' => 'Категории доступного транспорта',
        'en' => 'Categories of available transportation',
        'uz' => 'Mavjud transport turlari',
    ],
    'Вместимость' => [
        'ru' => 'Вместимость',
        'en' => 'Capacity',
    ...
    'Поездки по городам Узбекистана' => [
        ...
        'uz' => 'O‘zbekiston shaharlar bo‘ylab sayohat',
    ],
    'Приглашаем вас отправиться с нами в увлекательное путешествие по городам Великого Шелкового Пути.' => [
        ...
        'uz' => 'Sizni Buyuk Ipak Yo\'li shaharlaridan qiziqarli sayohatga taklif qilamiz.',
    ],
    'about_content' => [
    ...
    'Если у вас возникли вопросы или вы не уверены в выборе, оставьте свои контактные данные. Мы свяжемся с вами для консультации.' => [
        'ru' => 'Если у вас возникли вопросы или вы не уверены в выборе, оставьте свои
                                контактные данные. Мы свяжемся с вами для консультации.',
        'en' => 'If you have any questions or are not sure about the choice, leave your own contact details. We will contact you for a consultation.',
        'uz' => 'Agar sizda biron bir savol bo\'lsa yoki tanlovga ishonchingiz komil bo\'lmasa, o\'zingiznikini qoldiring
    ...
    'success_alert' => [
        ...
        'uz' => 'Sizning arizangiz muvaffaqiyatli yuborildi',
    ],
    'city_desc1' => [
        'ru' => 'Присоединяйтесь к захватывающей экскурсии по Самарканду и окунитесь в величие его истории и культуры. Путешествуйте с комфортом нашего транспорта и исследуйте архитектурные шедевры, такие как Регистан, Шахи-Зинда и Гур Эмир. Получите возможность открыть для себя тайны и богатства Самарканда в этой незабываемой экскурсии.',
        'en' => 'Join our captivating excursion through Samarkand and delve into the magnificence of its history and culture.                                                                                                                                                                                                                   Travel comfortably aboard our transport as you explore architectural wonders like Registan, Shah-i-Zinda, and Gur Emir.                                                                                                                                                                                     Discover the secrets and treasures of Samarkand on this unforgettable excursion.',
        'uz' => 'Samarqand bo\'ylab hayajonli sayohatga qo\'shiling va uning tarixi va madaniyatining ulug\'vorligiga sho\'ngi\'ing. Transportimiz qulayligi bilan sayohat qiling va Registon, shahi-Zinda va gur Amir kabi me\'moriy durdonalarni o\'rganing. Ushbu unutilmas ekskursiyada Samarqand sirlari va boyliklarini kashf etish imkoniyatiga ega bo\'ling.',
    ],
    'city_desc2' => [
        'ru' => 'Отправляйтесь в путешествие в Шахрисабз через горный серпантин. Наши удобные автомобили обеспечат безопасность и комфорт во время вашего путешествия, позволяя вам полностью погрузиться в атмосферу приключения. Откройте для себя волшебство этого удивительного места и познакомьтесь поближе с историей и культурой Шахрисабза, города, где родился Амир Темур.',
        'en' => 'Head on a journey to Shakhrisabz via the mountainous serpentine.                                                                                                                                                                                                                                                                                          Our comfortable vehicles guarantee safety and comfort throughout your trip, allowing you to fully immerse yourself in the adventure.                                                                                                                                                               Discover the enchantment of this extraordinary place and delve into the history and culture of Shakhrisabz, the birthplace of Amir Temur.',
        'uz' => "Tog'li serpantin orqali Shahrisabzga sayohat qiling. Bizning qulay mashinalarimiz sayohatingiz davomida xavfsizlik va qulaylikni ta'minlaydi, bu sizga sarguzasht muhitiga to'liq sho'ng'ish imkonini beradi. Ushbu ajoyib joyning sehrini kashf eting va Amir Temur tug'ilgan Shahrisabz tarixi va madaniyati bilan yaqindan tanishing.",
    ],
    'city_desc3' => [
        'ru' => 'Приглашаем вас отправиться в увлекательное путешествие в Ташкент, столицу Узбекистана. В Ташкенте вы встретите величественные архитектурные памятники, оживленные базары, уютные парки и множество культурных мероприятий. Наш транспорт обеспечит вас комфортным путешествием, чтобы вы могли насладиться каждым мгновением вашего пребывания в этом захватывающем городе.',
        'en' => 'Embark on an exciting journey to Tashkent, the capital of Uzbekistan.                                                                                                                                                                                                                                                                                              In Tashkent, you will encounter magnificent architectural monuments, bustling bazaars, cozy parks, and numerous cultural events.                                                                                                                                                                         Our transport will ensure you a comfortable journey so that you can enjoy every moment of your stay in this captivating city.',
        'uz' => "Sizni O'zbekiston poytaxti Toshkentga qiziqarli sayohatga taklif qilamiz. Toshkentda siz ulug'vor me'moriy yodgorliklar, jonli bozorlar, shinam bog'lar va ko'plab madaniy tadbirlarni uchratasiz. Bizning transportimiz sizni qulay sayohat bilan ta'minlaydi, shunda siz ushbu hayajonli shaharda bo'lganingizning har bir daqiqasidan bahramand bo'lishingiz mumkin.",
    ],
    'Экскурсия по Самарканду' => [
        'ru' => 'Экскурсия по Самарканду',
        'en' => 'Samarkand City Tour',
        'uz' => 'Samarqandga sayohat',
    ],
    'Поездка в Хиву' => [
        'ru' => 'Поездка в Хиву',
        'en' => 'A trip to Khiva',
    ...
    'Поездка в Шахрисабз' => [
        ...
        'uz' => 'Shahrisabzga sayohat',
    ],
    'Поездка в Ташкент' => [
        'ru' => 'Поездка в Ташкент',
        'en' => 'A trip to Tashkent',
        'uz' => 'Toshkentga sayohat',
    ],
    'city_desc4' => [
        ...
        'uz' => "Zamonaviy va qulay transportimizda sayohat qilib, qadimiy Nurataning noyob atmosferasiga sho'ng'ing har bir tosh ko'p asrlik tarix va madaniyat izlarini saqlaydigan Nurataning ajoyib dunyosiga duch keling.                                                                                                                                                                                           Nurataga sayohatni tashkil qilish bo'yicha xizmatlarimiz sizga ajoyib qulaylik va sayohatning har bir daqiqasidan bahramand bo'lish imkoniyatini beradi, bu sizga marshrutni rejalashtirish bilan chalg'imasdan, ushbu maftunkor shaharni o'rganishga to'liq sho'ng'ish imkonini beradi.",
    ],
    'city_desc5' => [
        ...
        'uz' => "Buxoroga sayohat qilib, bizning zamonaviy va qulay transportimizda uning ajoyib go'zalligini o'rganing. Ipak yo'lining boy tarixi va madaniy merosining jonli guvohi bo'lib xizmat qiladigan ushbu sehrli shahar bilan tanishing.                                                                                                                            Buxoroga sayohatni tashkil qilish bo'yicha xizmatlarimiz sizga mukammal qulaylik va sayohatning har bir daqiqasidan bahramand bo'lish imkoniyatini kafolatlaydi, bu sizga rejalashtirish tafsilotlariga emas, balki tajribalarga e'tibor qaratish imkonini beradi.",
    ],
    'city_desc6' => [
        ...
        'uz' => "Zamonaviy va qulay transportimizda sayohat qilib, Xivaning o'ziga xos atmosferasiga sho'ng'ing.                                                                                                                                                                          Ushbu qadimiy shaharni kashf eting, u erda har bir burchak o'z hikoyasini aytib beradi va havo ko'p asrlik an'analarga boy.                                                                                                                                                Xivaga sayohatni tashkil qilish bo'yicha xizmatlarimiz sizga maksimal qulaylik va tashkiliy daqiqalardan chalg'imasdan sayohatning har bir daqiqasidan bahramand bo'lish imkoniyatini kafolatlaydi."
    ],
    'Поездка в Нурату' => [
        'ru' => 'Поездка в Нурату',
        'en' => 'A trip to Nurata',
    ...
    'address' => [
        ...
        'uz' => '<span>Manzil</span>: <br> Grebnoy kanali, Samarqand, O`zbekiston',
    ],
    'Our Contact' => [
        'ru' => 'Наши контакты',
        'en' => 'Our Contacts',
